...
public class EAItems {
    ...
    public static final ItemEntry<Item> ULV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> LV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> MV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> HV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> EV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> IV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> LUV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> ZPM_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> UV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> UHV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> UEV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
    ...
    public static final ItemEntry<Item> UIV_UNIVERSAL_CIRCUIT = EXTRA_ADDITIONS_REGISTRATE
